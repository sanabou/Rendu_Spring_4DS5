...
public class ClientService implements IClientService {
    ...
    public List<Client> listeDeClientsParCategorie(Categorie categorie) {
        return clientRepository.clientParCategorie(categorie);
    }

    @Override
    @Scheduled(fixedRate = 30000)
    public void nbreClientParGenre() {
        int femme = clientRepository.nbrClientFemme();
        int homme = clientRepository.nbrClientHomme();

        System.out.println("Nombre de femmes : " + femme + ", Nombre d'Hommes : "+homme);
    }
}
